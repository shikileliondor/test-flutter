...
class _HomeScreenState extends State<HomeScreen> {
                            ...
                            Navigator.of(context).push(
                              MaterialPageRoute<void>(
                                builder: (_) => MetierDetailScreen(
                                  metier: _buildMetierFromFiliere(filiere, index),
                                ),
                              ),
                            );
                          },
  ...
  Metier _buildMetierFromFiliere(Filiere filiere, int index) {
    return Metier(
      id: index + 1,
      nom: filiere.nom,
      ...
      roadmap: RoadmapMetier(
        diplomeRequis: filiere.niveau,
        competencesAApprendre: filiere.competences,
